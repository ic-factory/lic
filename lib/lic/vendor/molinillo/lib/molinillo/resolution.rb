...
module Lic::Molinillo
  class Resolver
    ...
    class Resolution
      ...
      require 'lic/vendor/molinillo/lib/molinillo/state'
      require 'lic/vendor/molinillo/lib/molinillo/modules/specification_provider'

      require 'lic/vendor/molinillo/lib/molinillo/delegates/resolution_state'
      require 'lic/vendor/molinillo/lib/molinillo/delegates/specification_provider'

      include Lic::Molinillo::Delegates::ResolutionState
      include Lic::Molinillo::Delegates::SpecificationProvider
