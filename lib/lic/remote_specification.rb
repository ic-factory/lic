...
module Lic
  ...
  class RemoteSpecification
    ...
    # is compatible with Gem::Specification and other Lic or RubyGems
    ...
    # RubyGems 2.23 and ensures that Lic's specifications can be
    ...
    def dependencies
      @dependencies ||= begin
        ...
        # see https://github.com/lic/lic/issues/5797
