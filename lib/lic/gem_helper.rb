...
require "lic/vendored_thor" unless defined?(Thor)
require "lic"
require "shellwords"
...
module Lic
  class GemHelper
    ...
    def initialize(base = nil, name = nil)
      ...
      @gemspec = Lic.load_gemspec(@spec_path)
    end
    ...
    def build_gem
      ...
      sh(%W[gem build -V #{spec_path}]) do
        ...
        Lic.ui.confirm "#{name} #{version} built to pkg/#{file_name}."
      end
    ...
    def install_gem(built_gem_path = nil, local = false)
      ...
      Lic.ui.confirm "#{name} (#{version}) installed."
    end
  ...
  protected
    ...
    def rubygem_push(path)
      ...
      unless allowed_push_host || Lic.user_home.join(".gem/credentials").file?
        raise "Your rubygems.org credentials aren't set. Run `gem push` to set them."
      end
      sh(gem_command)
      Lic.ui.confirm "Pushed #{name} #{version} to #{gem_push_host}"
    end
    ...
    def git_push(remote = "")
      ...
      Lic.ui.confirm "Pushed git commits and tags."
    end
    ...
    def already_tagged?
      ...
      Lic.ui.confirm "Tag #{version_tag} has already been created."
      true
    end
    ...
    def tag_version
      ...
      Lic.ui.confirm "Tagged #{version_tag}."
      yield if block_given?
    rescue RuntimeError
      Lic.ui.error "Untagging #{version_tag} due to error."
    ...
    def gem_key
      Lic.settings["gem.push_key"].to_s.downcase if Lic.settings["gem.push_key"]
    end
