...
module Lic
  ...
  module Plugin
    class Installer
      autoload :Rubygems, "lic/plugin/installer/rubygems"
      autoload :Git,      "lic/plugin/installer/git"
      ...
      def install(names, options)
        ...
        Lic.settings.temporary(:lockfile_uses_separate_rubygems_sources => false, :disable_multisource => false) do
          if options[:git]
            install_git(names, version, options)
          elsif options[:local_git]
            install_local_git(names, version, options)
          else
            sources = options[:source] || Lic.rubygems.sources
