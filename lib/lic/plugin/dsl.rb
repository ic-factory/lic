...
module Lic
  module Plugin
    ...
    class DSL < Lic::Dsl
      ...
      # by name lic-source-<type> to list of plugins to be installed.
      #
      ...
      def method_missing(name, *args)
        raise PluginGemfileError, "Undefined local variable or method `#{name}' for Gemfile" unless Lic::Dsl.method_defined? name
      end
      ...
      def source(source, *args, &blk)
        ...
        plugin_name = "lic-source-#{options["type"]}"
