    ...
    class API
      ...
      module Source
        ...
        def post_install(spec, disable_exts = false)
          ...
          installer = Lic::Source::Path::Installer.new(spec, opts)
        ...
        #
        # @return [Lic::Index] index containing the specs
        def specs
          files = fetch_gemspec_files

          Lic::Index.build do |index|
            files.each do |file|
              next unless spec = Lic.load_gemspec(file)
